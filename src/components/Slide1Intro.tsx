...
export default function Slide1Intro({ onNext }: Props) {
  ...
  // Planets - Fixed positions, not random
  const planets = useMemo(() => {
    return [
      { id: 0, type: 'saturn', size: 60, top: 15, left: 80, animationDuration: 15, yOffset: 15, colors: 'from-orange-300 to-amber-800', shadow: 'shadow-[inset_-10px_-10px_20px_rgba(0,0,0,0.6),0_0_20px_rgba(251,191,36,0.2)]' },
      { id: 1, type: 'ice', size: 40, top: 25, left: 15, animationDuration: 12, yOffset: 12, colors: 'from-cyan-200 to-blue-800', shadow: 'shadow-[inset_-10px_-10px_20px_rgba(0,0,0,0.6),0_0_20px_rgba(34,211,238,0.2)]' },
      { id: 2, type: 'mars', size: 50, top: 70, left: 75, animationDuration: 18, yOffset: 18, colors: 'from-red-400 to-red-900', shadow: 'shadow-[inset_-10px_-10px_20px_rgba(0,0,0,0.6),0_0_20px_rgba(248,113,113,0.2)]' },
      { id: 3, type: 'rocky', size: 35, top: 60, left: 20, animationDuration: 14, yOffset: 10, colors: 'from-stone-400 to-stone-800', shadow: 'shadow-[inset_-10px_-10px_20px_rgba(0,0,0,0.6),0_0_20px_rgba(168,162,158,0.2)]' },
    ];
  }, []);
