...
import { Rocket, Star, Sparkles, BookOpen, MessageCircleQuestion, Hand } from 'lucide-react';
      ...
      <div className="flex-1 flex flex-col items-center justify-center max-w-6xl mx-auto w-full z-10 gap-8">
        <AnimatePresence mode="wait">
          {step === 0 && (
            ...
            >
              <Star className="text-yellow-400 fill-yellow-400 mb-8" size={80} />
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                onClick={handleNext}
                className="bg-gradient-to-r from-cyan-500 to-blue-600 text-white px-16 py-6 rounded-full text-3xl font-bold shadow-[0_0_40px_rgba(34,211,238,0.4)] border-2 border-cyan-300/50 flex items-center gap-4"
              >
                下一页
          ...
          {step === 1 && (
            ...
            >
              <div className="w-full bg-slate-900/80 backdrop-blur-md p-10 rounded-3xl shadow-[0_0_40px_rgba(56,189,248,0.2)] border border-cyan-500/30 relative overflow-hidden">
                ...
                <ul className="space-y-6 text-2xl md:text-3xl text-slate-200 leading-relaxed font-medium ml-4">
                  <motion.li initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 0.2 }} className="flex items-start gap-4">
                    <span className="text-cyan-400 mt-1">🚀</span>
                    <p>认识了什么是<strong className="text-cyan-300 mx-2 text-4xl">正比例关系</strong>：两种相关联的量，一种量变化，另一种量也随着变化。</p>
                  </motion.li>
                  <motion.li initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 0.4 }} className="flex items-start gap-4">
          ...
          {step === 2 && (
            <motion.div
              ...
              className="text-center flex flex-col items-center justify-center"
            >
              <MessageCircleQuestion className="text-fuchsia-400 mb-8" size={80} />
              <h3 className="text-5xl md:text-7xl font-black text-white mb-16">
                星际探讨：你还有什么疑问吗？
              </h3>
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                onClick={handleNext}
                className="bg-gradient-to-r from-purple-500 to-fuchsia-600 text-white px-16 py-6 rounded-full text-3xl font-bold shadow-[0_0_40px_rgba(168,85,247,0.4)] border-2 border-purple-300/50 flex items-center gap-4"
              >
                <Sparkles size={36} />
                思考题
              </motion.button>
            ...
            >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-xl md:text-2xl text-indigo-100">
                <motion.div 
                  ...
                  className="bg-slate-950/50 p-6 rounded-2xl border border-indigo-500/30 hover:border-indigo-400 transition-colors"
                >
