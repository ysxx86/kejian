          ...
          {step === 0 && (
            ...
            >
              ...
              >
                ...
                <div className="absolute left-1/2 -translate-x-1/2 bottom-[-35px] flex justify-center">
                  {[...Array(7)].map((_, i) => (
                    <motion.div
                      key={i}
                      className="w-2 h-8 mx-[2px] rounded-full"
                      style={{
              ...
              <h1 className="text-6xl md:text-8xl font-black mb-12 bg-gradient-to-r from-cyan-300 via-purple-300 to-pink-300 text-transparent bg-clip-text drop-shadow-[0_0_30px_rgba(192,132,252,0.5)]">
                星际旅行计划
              </h1>
